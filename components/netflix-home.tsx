...
export function NetflixHome() {
  return (
    <main className="min-h-screen bg-black">
          ...
          >
            ...
            >
              {["Frontend", "Full Stack", "Product Design", "2026"].map((tag, idx) => (
                <div
                  key={idx}
                  className="px-4 py-2 rounded-full bg-white/5 border border-white/10 text-xs font-medium text-white/60 backdrop-blur-sm"
                >
                  {tag}
                </div>
              ))}
      ...
      <section id="design" className="py-4">
        <ProjectRail title="Design Work" projects={[...featuredProjects].reverse()} />
      </section>

      <section id="builds" className="py-4">
        <ProjectRail title="Developer Builds" projects={featuredProjects} />
      </section>

      <section id="experiments" className="py-4">
        <ProjectRail title="Experiments" projects={featuredProjects.slice(0, 3)} />
      </section>
